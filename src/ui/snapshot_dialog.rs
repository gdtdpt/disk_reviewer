use egui::{Color32, RichText, StrokeKind, Window};
...
/// Render the snapshot management dialog using a standard egui Window.
///
    ...
    Window::new("快照管理")
        ...
        .show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                let create_btn = ui.add_enabled(create_enabled, egui::Button::new("新建"));
                    ...
                    ui.horizontal(|ui| {
                        ...
                        if ui.button("确认").clicked() {
                            if !dialog.rename_buffer.is_empty() {
                                action =
                                    SnapshotAction::Rename(sel_id, dialog.rename_buffer.clone());
            ...
            ui.horizontal(|ui| {
                let rename_btn = ui.add_enabled(sel_selected, egui::Button::new("重命名"));
                ...
                let delete_btn = ui.add_enabled(sel_selected, egui::Button::new("删除"));
                ...
                let compare_btn =
                    ui.add_enabled(sel_selected && scan_available, egui::Button::new("对比"));
